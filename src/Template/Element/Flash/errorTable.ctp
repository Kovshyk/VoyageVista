...
<div id="system_msg_wrapper" class="fixed system_error">
    ...
    <div class="system_msg_body">
        ...
        <div class="system_msg">
            <span class="system_msg_title"> <?php if(isset($params['title'])){echo $params['title'];} ?></span>
            <?php if(is_array($message)) { foreach ($message as $key => $val) { ?>
            <p><?php echo $key.':'; foreach ($val as $val1) { echo ' '. $val1.'<br>'; } ?> </p>
            <?php }} ?>
        </div>
