...
var handleSlimScroll = function () {
    ...
    $("[data-click=panel-remove]").hover(function () {
        ...
        if (0 !== $(t).length) {
            var l = $(a).offset().top, n = $(t).offset().top;
            i = n - l
        }
    ...
    function e(e, a) {
        var t = (parseInt($(e).css("margin-left")), $(e).width()), i = $(e).find("li.active").width(),
            l = a > -1 ? a : 150, n = 0;
        if ($(e).find("li.active").prevAll().each(function () {
            ...
            var s = i - t;
            n != i && (s += 40), $(e).find(".nav.nav-tabs").animate({marginLeft: "-" + s + "px"}, l)
        }
        i != n && n >= t ? $(e).addClass("overflow-right") : $(e).removeClass("overflow-right"), i >= t && n >= t ? $(e).addClass("overflow-left") : $(e).removeClass("overflow-left")
    }

    function a(e, a) {
        var t = $(e).closest(".tab-overflow"), i = parseInt($(t).find(".nav.nav-tabs").css("margin-left")),
            l = $(t).width(), n = 0, s = 0;
        switch ($(t).find("li").each(function () {
            ...
            case"next":
                ...
                }, 150)) : s = l - i - 80, 0 != s && $(t).find(".nav.nav-tabs").animate({marginLeft: "-" + s + "px"}, 150, function () {
                    $(t).addClass("overflow-left")
                });
                break;
            case"prev":
                var o = -i;
                l >= o ? ($(t).removeClass("overflow-left"), s = 0) : s = o - l + 80, $(t).find(".nav.nav-tabs").animate({marginLeft: "-" + s + "px"}, 150, function () {
    ...
    function t() {
        $(".tab-overflow").each(function () {
            var a = $(this).width(), t = 0, i = $(this), l = a;
    ...
    $(".page-sidebar-minified .sidebar [data-scrollbar=true] a").live("touchstart", function (a) {
        ...
        if (a.preventDefault(), /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
            var t = a.originalEvent.touches[0] || a.originalEvent.changedTouches[0], i = t.pageY, l = i - e;
        ...
        var a = $(this).closest("[data-scrollbar=true]"), t = $(window).height(),
            i = parseInt($("#sidebar").css("padding-top")), l = $("#sidebar").height();
        e = $(a).css("margin-top");
        var n = i;
        ...
        if (s >= n && n >= t && n >= l) {
            var o = t - n - 20;
            $(a).animate({marginTop: o + "px"})
        } else parseInt(e) >= 0 || l >= n ? $(a).animate({marginTop: "0px"}) : (o = e, $(a).animate({marginTop: o + "px"}))
    })
}, App = function () {
    "use strict";
    return {
